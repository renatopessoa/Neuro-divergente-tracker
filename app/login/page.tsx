            ...
            >
              ...
              <p className="mt-8 text-center text-sm text-slate-500">
                ...
                <button 
                  ...
                  className="text-indigo-600 font-medium cursor-pointer hover:underline bg-transparent border-none p-0"
                >
                  Solicite acesso
                </button>
              </p>
            ...
            >
              <div className="flex flex-col items-center mb-8">
                <button 
                  ...
                  className="self-start mb-4 p-2 hover:bg-slate-50 rounded-full transition-colors text-slate-500"
                >
                  <ArrowLeft size={20} />
                </button>
                ...
                <p className="text-slate-500 text-center">Preencha seus dados para solicitar acesso</p>
              </div>
              ...
              {success && (
                <div className="mb-6 p-4 bg-emerald-50 border border-emerald-100 text-emerald-700 rounded-xl text-sm flex items-center gap-2">
